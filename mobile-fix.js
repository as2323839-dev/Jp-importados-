(function(){
  ...
  style.textContent=`
    @media(max-width:600px){
      ...
      .jp-m-hero{position:relative;width:100%;height:auto;overflow:visible;background:#000;border-top:1px solid #5c3b1a;border-bottom:1px solid #5c3b1a;padding-bottom:18px}
      .jp-m-hero img{position:static;display:block;width:100%;height:auto;object-fit:contain;object-position:center;transform:none}
      .jp-m-hero:after{content:none}
      .jp-m-hero-cta{position:static;display:block;width:calc(100% - 48px);margin:18px 24px 0;min-height:56px;border:1px solid #b97a22;background:#dfa735;color:#080808;border-radius:28px;font-size:16px;font-weight:900}
